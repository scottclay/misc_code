object LearningScala1 {
  ...
  val hello: String = "Salut!"                    //> hello  : String = Salut!
  println(hello)                                  //> Salut!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Salut!
  helloThere = hello + " There!"
  println(helloThere)                             //> Salut! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Salut!There!
  println(immutableHelloThere)                    //> Salut!There!
  val moreStuff = immutableHelloThere + "yeah"    //> moreStuff  : String = Salut!There!yeah
  ...
  val pi_times_two = pi*2                         //> pi_times_two  : Double = 6.2831853
  println(f"Two x Pi is about $pi_times_two%.3f") //> Two x Pi is about 6.283
