object LearningScala3 {
  ...
  def caps(x: String): String = {
  	x.toUpperCase
  	}                                         //> caps: (x: String)String
  
  println(caps("hello"))                          //> HELLO
  println(caps("goodbye"))                        //> GOODBYE
  
 def caps_literal(x: String, f: String => String): String = {
  	f(x)
 	}                                         //> caps_literal: (x: String, f: String => String)String
 
 caps_literal("HellO", x=>x.toUpperCase)          //> res3: String = HELLO
